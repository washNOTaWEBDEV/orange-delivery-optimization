...
- A working list, kept locally, of the 220 localities whose centres fall inside a run outline on the map screenshot, with their census populations (approximate near the outlines; the KML was not used). By population, localities inside only the Warrnambool outline total about 48,300 people, Hamilton about 42,300 (about 27,000 without Horsham, which rarely appears) and Portland about 20,900, with about 300 in localities in overlaps. A further 65 localities lie within about 3 km of an outline, so their run is uncertain.
